    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(max_length=255, verbose_name=b'\xe7\xb8\xa3')),
                ('area', models.CharField(max_length=255, verbose_name=b'\xe5\x8d\x80')),
                ('vil', models.CharField(max_length=255, verbose_name=b'\xe9\x87\x8c', blank=True)),
                ('nei', models.CharField(max_length=255, verbose_name=b'\xe9\x84\xb0', blank=True)),
                ('rd', models.CharField(max_length=255, verbose_name=b'\xe8\xb7\xaf', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('is_del', models.BooleanField(verbose_name=b'\xe5\x81\x9c\xe7\x94\xa8')),
                ...
                ('password', models.CharField(max_length=255, verbose_name=b'\xe5\xaf\x86\xe7\xa2\xbc')),
                ...
                ('address', models.ForeignKey(verbose_name=b'\xe5\x9c\xb0\xe5\x9d\x80', to='visit.address')),
                ('introducer', models.ForeignKey(verbose_name=b'\xe4\xbb\x8b\xe7\xb4\xb9\xe4\xba\xba', to='visit.people', null=True)),
            ],
        ),
    ]
